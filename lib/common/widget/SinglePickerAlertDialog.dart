...
class SinglePickerAlertDialog<T> extends StatefulWidget {
  ...
  SinglePickerAlertDialog(
      this.title, this.inputTitle, this.options, this.callback);
  @override
  _SinglePickerAlertDialogState<T> createState() =>
      _SinglePickerAlertDialogState<T>();
}

class _SinglePickerAlertDialogState<T>
    extends State<SinglePickerAlertDialog<T>> {
  T selectedOption;
